...
function updata(e){
    ...
    if(select1==9 && select!=9.4){
        window.location.href='./ch9.html'
    }else if(select==10.1){
        window.location.href='./ch10.html'
    }else if(select==9.4){
        window.location.href='https://www.socscistatistics.com/tests/multipleregression/default.aspx'
    }else if(select==10.2){
        window.location.href='./ch102.html'
    }
    else if(select=='分配表'){
        window.location.href='./ch103.html'
    }
    else if(select=='字數計算機'){
        window.location.href='./wcal.html'
    }
}